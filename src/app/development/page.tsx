...
import PlaylistTile from "../_components/PlaylistTile";


export default function Page() {
    return (
        <VStack>
            <Profile profileProps={basicprofile}></Profile>

            <HStack>
                <Box borderWidth='3px' borderRadius='lg'>
                    <Text as='b'> Fetch Library by URI</Text>
                    <Text>A lightweight option</Text>
                </Box>
...
const basicprofile = {
    ...
    "images": [
        {
            "url": "https://i.scdn.co/image/ab67757000003b828915e046e9801473b80d8e2b",
            "height": 64,
            "width": 64
        },
        {
            "url": "https://i.scdn.co/image/ab6775700000ee858915e046e9801473b80d8e2b",
            "height": 300,
            "width": 300
        }
    ],
